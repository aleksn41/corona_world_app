...
public class Mapper {
    ...
    public static ISOCountry mapISOCodeToISOCountry(String isoCode) {
        if (isoCode.length() != 2)
            throw new IllegalArgumentException("The given String is no ISOCode! Example:\"DE\"");
    ...
    public static GermanyState mapISOCodeToGermanyState(String isoCode) {
        if (isoCode.length() != 5)
            throw new IllegalArgumentException("The given String is no ISOCode! Example:\"DE-RP\"");
