...
public class StatisticCallAdapter extends ListAdapter<Pair<StatisticCall, Boolean>, StatisticCallViewHolder> {
    ...
    private final ActionMode.Callback actionMode = new ActionMode.Callback() {
        ...
        public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
            if (item.getItemId() == R.id.action_delete) {
                ...
                Log.d(this.getClass().getName(), "clicked on favourite Item");
        ...
        public void onDestroyActionMode(ActionMode mode) {
            Log.d(this.getClass().getName(), "finished Action Mode");
    ...
    public void onBindViewHolder(@NonNull StatisticCallViewHolder holder, int position) {
        ...
        if (itemOnActionCallback != null) {
            holder.getSparkButton().setOnClickListener(v -> itemOnActionCallback.callback(holder.getAdapterPosition()));
            Log.v(this.getClass().getName(), "toggle favourite mark of item with real index " + holder.getAdapterPosition());
        }
    ...
    private void selectItem(int itemID, @NonNull StatisticCallViewHolder holder) {
        Log.d(this.getClass().getName(), "selecting Item");
